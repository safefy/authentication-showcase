...
class BillingCentralExpenseImageRecyclerViewAdapter(val items: MutableList<String>,
                                                    val context: Context) : RecyclerView.Adapter<BillingCentralExpenseImageRecyclerViewAdapter.ViewHolder>() {
