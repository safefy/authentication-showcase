...
class MessageDetailImageRecyclerViewAdapter(val items: List<String>,
                                            val context: Context) : RecyclerView.Adapter<MessageDetailImageRecyclerViewAdapter.ViewHolder>() {
